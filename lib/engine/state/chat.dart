...
class ChatThread {
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
    ...
    if (lastActivity != null) 'last': lastActivity!.millisecondsSinceEpoch,
  };
  ...
  factory ChatThread.fromJson(Map<String, dynamic> json) => ChatThread(
    ...
    lastActivity: json['last'] == null
        ? null
        : DateTime.fromMillisecondsSinceEpoch((json['last'] as num).toInt()),
  );
}
...
class CharacterState {
  ...
  factory CharacterState.fromJson(Map<String, dynamic> json) => CharacterState(
    ...
    lastSeen: json['seen'] == null
        ? null
        : DateTime.fromMillisecondsSinceEpoch((json['seen'] as num).toInt()),
  );
}
