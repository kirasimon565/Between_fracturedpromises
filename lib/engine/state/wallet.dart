...
class Wallet {
  ...
  Wallet grantEntitlement(String sku) => copyWith(
    ownedSkus: ownedSkus.contains(sku)
        ? ownedSkus
        : <String>[...ownedSkus, sku],
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
    ...
    if (lastRestoreAt != null) 'restore': lastRestoreAt!.millisecondsSinceEpoch,
  };
  ...
  factory Wallet.fromJson(Map<String, dynamic> json) => Wallet(
    ...
    lastRestoreAt: json['restore'] == null
        ? null
        : DateTime.fromMillisecondsSinceEpoch((json['restore'] as num).toInt()),
  );
}
