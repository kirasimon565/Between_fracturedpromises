...
CommandOutcome _ui(CommandContext ctx) {
  ctx.engine.emitEffect(
    GenericEffect('ui', <String, Object?>{
...
CommandOutcome _overlay(CommandContext ctx) {
  ctx.engine.emitEffect(
    GenericEffect('overlay', <String, Object?>{
      'mode': ctx.str(0, 'show'),
...
CommandOutcome _hud(CommandContext ctx) {
  ctx.engine.emitEffect(
    GenericEffect('hud', <String, Object?>{
...
CommandOutcome _animate(CommandContext ctx) {
  ctx.engine.emitEffect(
    GenericEffect('animate', <String, Object?>{
      'name': ctx.str(0),
...
CommandOutcome _shatter(CommandContext ctx) {
  ...
  ctx.engine.emitEffect(ScreenEffect(effect: 'shatter', duration: duration));
