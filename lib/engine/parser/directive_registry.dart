...
class DirectiveRegistry {
  ...
  static const Set<String> genericModifiers = <String>{
    'volume', 'loop', 'fade', 'duration', 'delay', 'speed', 'status', 'at',
    'to', 'from', 'with', 'as', 'style', 'color', 'icon', 'sound', 'priority',
    'timeout', 'default', 'count', 'id', 'title', 'group', 'cost', 'requires',
    'mode', 'position', 'target', 'tag', 'url', 'page', 'app', 'text', 'body',
    'image', 'kind', 'type', 'value', 'min', 'max', 'seconds', 'ms', 'curve',
    'align', 'size', 'weight', 'when', 'unless', 'label', 'note', 'category',
    'avatar', 'subtitle',
  };
}
...
const List<DirectiveSpec> builtinDirectives = <DirectiveSpec>[
  ...
  DirectiveSpec('return',
      category: DirectiveCategory.control,
      shape: DirectiveShape.structural,
      summary: 'Returns from the innermost @call.'),
  DirectiveSpec('include',
      category: DirectiveCategory.control,
      shape: DirectiveShape.structural,
  ...
  DirectiveSpec('if',
      category: DirectiveCategory.control, shape: DirectiveShape.structural),
  DirectiveSpec('elseif',
      category: DirectiveCategory.control,
      shape: DirectiveShape.structural,
      aliases: <String>['elif']),
  DirectiveSpec('else',
  ...
  DirectiveSpec('endif',
      ...
      aliases: <String>['fi']),
  DirectiveSpec('switch',
      category: DirectiveCategory.control, shape: DirectiveShape.structural),
  DirectiveSpec('case',
      category: DirectiveCategory.control, shape: DirectiveShape.structural),
  DirectiveSpec('default',
      category: DirectiveCategory.control, shape: DirectiveShape.structural),
  DirectiveSpec('endswitch',
      category: DirectiveCategory.control, shape: DirectiveShape.terminator),
  DirectiveSpec('while',
      category: DirectiveCategory.control, shape: DirectiveShape.structural),
  DirectiveSpec('endwhile',
      category: DirectiveCategory.control, shape: DirectiveShape.terminator),
  DirectiveSpec('repeat',
      category: DirectiveCategory.control, shape: DirectiveShape.structural),
  DirectiveSpec('endrepeat',
      category: DirectiveCategory.control, shape: DirectiveShape.terminator),
  DirectiveSpec('for',
      category: DirectiveCategory.control, shape: DirectiveShape.structural),
  DirectiveSpec('endfor',
      category: DirectiveCategory.control, shape: DirectiveShape.terminator),
  DirectiveSpec('break',
      category: DirectiveCategory.control, shape: DirectiveShape.structural),
  DirectiveSpec('continue',
      category: DirectiveCategory.control, shape: DirectiveShape.structural),
  ...
  // ── Messaging ───────────────────────────────────────────────────────────
  DirectiveSpec('message',
      category: DirectiveCategory.messaging,
      aliases: <String>['msg', 'say'],
      named: <String>{
        'delay', 'app', 'thread', 'avatar', 'attachment', 'image', 'audio',
        'sound', 'reply', 'status', 'style', 'sender', 'time', 'reaction',
      },
      minPositional: 1,
      summary: 'Sends a chat message from a character.'),
  DirectiveSpec('typing',
      category: DirectiveCategory.messaging,
      named: <String>{'app', 'thread', 'seconds'},
      minPositional: 1,
      summary: 'Shows the typing indicator for N seconds.'),
  DirectiveSpec('narration',
      category: DirectiveCategory.messaging,
      aliases: <String>['narrate', 'narrator'],
      named: <String>{'style', 'delay', 'align'}),
  DirectiveSpec('thought',
      category: DirectiveCategory.messaging,
      aliases: <String>['think'],
      named: <String>{'delay', 'style'}),
  DirectiveSpec('system',
      category: DirectiveCategory.messaging, named: <String>{'style'}),
  DirectiveSpec('seen',
      category: DirectiveCategory.messaging, named: <String>{'thread', 'at'}),
  DirectiveSpec('unsend',
      category: DirectiveCategory.messaging, named: <String>{'thread'}),
  DirectiveSpec('reaction',
      category: DirectiveCategory.messaging, named: <String>{'thread', 'emoji'}),
  DirectiveSpec('clear_chat',
      category: DirectiveCategory.messaging, named: <String>{'thread', 'app'}),
  DirectiveSpec('thread',
      category: DirectiveCategory.messaging,
      named: <String>{'app', 'title', 'avatar', 'pinned', 'muted'},
      summary: 'Opens/creates a conversation thread.'),
  DirectiveSpec('character',
      category: DirectiveCategory.messaging,
  ...
  // ── Choices ─────────────────────────────────────────────────────────────
  DirectiveSpec('choice',
      category: DirectiveCategory.choice,
      shape: DirectiveShape.structural,
      named: <String>{'timeout', 'default', 'prompt', 'style', 'shuffle'}),
  DirectiveSpec('endchoice',
      category: DirectiveCategory.choice, shape: DirectiveShape.terminator),

  // ── Variables & flags ───────────────────────────────────────────────────
  DirectiveSpec('set',
      category: DirectiveCategory.variables, shape: DirectiveShape.structural),
  DirectiveSpec('add',
      category: DirectiveCategory.variables, shape: DirectiveShape.structural),
  DirectiveSpec('subtract',
      category: DirectiveCategory.variables,
      shape: DirectiveShape.structural,
      aliases: <String>['sub']),
  DirectiveSpec('unset_var',
      category: DirectiveCategory.variables, aliases: <String>['delete_var']),
  DirectiveSpec('flag',
  ...
  DirectiveSpec('love',
      ...
      named: <String>{'min', 'max', 'silent'},
      minPositional: 1),
  DirectiveSpec('tension',
      category: DirectiveCategory.relationships, minPositional: 1),
  DirectiveSpec('suspicion',
      category: DirectiveCategory.relationships, minPositional: 1),
  DirectiveSpec('relationship',
      category: DirectiveCategory.relationships,
  ...
  DirectiveSpec('remove_item',
      category: DirectiveCategory.inventory,
      aliases: <String>['take'],
      named: <String>{'count'}),
  DirectiveSpec('inventory',
      category: DirectiveCategory.inventory, named: <String>{'mode'}),
  DirectiveSpec('evidence',
  ...
  DirectiveSpec('evidence_link',
      category: DirectiveCategory.evidence, named: <String>{'with', 'result'}),
  DirectiveSpec('journal',
      category: DirectiveCategory.journal,
      named: <String>{'title', 'body', 'category', 'mood', 'image'}),
  DirectiveSpec('journal_update',
      category: DirectiveCategory.journal, named: <String>{'body'}),
  DirectiveSpec('objective',
      category: DirectiveCategory.objectives,
      named: <String>{'title', 'description', 'optional', 'group'}),
  DirectiveSpec('objective_complete',
      category: DirectiveCategory.objectives, aliases: <String>['complete']),
  DirectiveSpec('objective_fail',
      category: DirectiveCategory.objectives),
  ...
  DirectiveSpec('background',
      category: DirectiveCategory.media,
      aliases: <String>['bg'],
      named: <String>{'fade', 'blur', 'tint'}),
  DirectiveSpec('video',
      category: DirectiveCategory.media, named: <String>{'loop', 'mute'}),
  DirectiveSpec('gallery_unlock',
  ...
  DirectiveSpec('stop_music',
      category: DirectiveCategory.audio, named: <String>{'fade'}),
  DirectiveSpec('sound',
      category: DirectiveCategory.audio,
      aliases: <String>['sfx', 'play'],
      named: <String>{'volume', 'delay'}),
  DirectiveSpec('ambience',
      category: DirectiveCategory.audio, named: <String>{'volume', 'fade'}),
  DirectiveSpec('vibrate',
      category: DirectiveCategory.audio, named: <String>{'duration', 'pattern'}),
  DirectiveSpec('mute', category: DirectiveCategory.audio),
  DirectiveSpec('unmute', category: DirectiveCategory.audio),

  // ── Phone OS ────────────────────────────────────────────────────────────
  DirectiveSpec('phone',
      category: DirectiveCategory.phone, named: <String>{'mode', 'theme'}),
  DirectiveSpec('phone_battery',
      category: DirectiveCategory.phone, aliases: <String>['battery']),
  ...
  DirectiveSpec('open_app',
      category: DirectiveCategory.phone,
      aliases: <String>['app_open'],
      named: <String>{'screen', 'thread', 'args'}),
  DirectiveSpec('close_app',
      category: DirectiveCategory.phone, aliases: <String>['app_close']),
  DirectiveSpec('install_app',
      category: DirectiveCategory.phone,
      aliases: <String>['app_install'],
      named: <String>{'app', 'name', 'icon', 'progress', 'source', 'duration'}),
  DirectiveSpec('uninstall_app',
      category: DirectiveCategory.phone, aliases: <String>['app_uninstall']),
  DirectiveSpec('notification',
      category: DirectiveCategory.phone,
  ...
  DirectiveSpec('contact',
      category: DirectiveCategory.phone,
      named: <String>{'number', 'avatar', 'note', 'blocked', 'favorite'}),
  DirectiveSpec('wallpaper', category: DirectiveCategory.phone),
  DirectiveSpec('badge',
      category: DirectiveCategory.phone, named: <String>{'app', 'count'}),

  // ── Calls ───────────────────────────────────────────────────────────────
  DirectiveSpec('call_incoming',
      category: DirectiveCategory.calls,
      named: <String>{'ringtone', 'timeout', 'video', 'accept', 'decline'}),
  DirectiveSpec('call_start',
      category: DirectiveCategory.calls, named: <String>{'video'}),
  DirectiveSpec('call_line',
      category: DirectiveCategory.calls, named: <String>{'delay'}),
  DirectiveSpec('call_end', category: DirectiveCategory.calls),
  DirectiveSpec('voicemail',
      category: DirectiveCategory.calls, named: <String>{'duration'}),
  DirectiveSpec('missed_call', category: DirectiveCategory.calls),

  // ── Browser ─────────────────────────────────────────────────────────────
  DirectiveSpec('browser_open',
      category: DirectiveCategory.browser,
      named: <String>{'tab', 'incognito', 'title'}),
  DirectiveSpec('browser_visit',
      category: DirectiveCategory.browser,
      named: <String>{'title', 'delay', 'tab'}),
  DirectiveSpec('browser_popup',
      category: DirectiveCategory.browser,
      named: <String>{'title', 'body', 'image', 'cta', 'target', 'closable'}),
  DirectiveSpec('browser_download',
      category: DirectiveCategory.browser,
      named: <String>{'app', 'name', 'icon', 'duration', 'size'}),
  DirectiveSpec('browser_close', category: DirectiveCategory.browser),
  DirectiveSpec('browser_bookmark',
      category: DirectiveCategory.browser, named: <String>{'title'}),
  DirectiveSpec('browser_history_clear', category: DirectiveCategory.browser),
  DirectiveSpec('browser_redirect',
      category: DirectiveCategory.browser, named: <String>{'delay'}),
  DirectiveSpec('browser_tab',
      category: DirectiveCategory.browser, named: <String>{'close', 'focus'}),

  // ── Animation ───────────────────────────────────────────────────────────
  DirectiveSpec('animate',
  ...
  DirectiveSpec('glitch',
      category: DirectiveCategory.animation,
      named: <String>{'duration', 'intensity'}),
  DirectiveSpec('fade',
      category: DirectiveCategory.animation,
      named: <String>{'duration', 'color', 'to'}),
  DirectiveSpec('shatter',
      category: DirectiveCategory.animation, named: <String>{'duration'}),
  ...
  DirectiveSpec('time',
      category: DirectiveCategory.environment, aliases: <String>['clock']),
  ...
  DirectiveSpec('theme',
      category: DirectiveCategory.environment, named: <String>{'mode'}),
  DirectiveSpec('advance_time',
      category: DirectiveCategory.environment,
      named: <String>{'minutes', 'hours'}),

  // ── Random ──────────────────────────────────────────────────────────────
  DirectiveSpec('random',
      category: DirectiveCategory.random,
      named: <String>{'min', 'max', 'into'},
      summary: 'Stores a random number in a variable.'),
  DirectiveSpec('random_pick',
      category: DirectiveCategory.random, named: <String>{'into'}),
  DirectiveSpec('chance',
      category: DirectiveCategory.random,
      shape: DirectiveShape.structural,
  ...
  // ── Events / scheduler ──────────────────────────────────────────────────
  DirectiveSpec('emit',
      category: DirectiveCategory.events, named: <String>{'data', 'delay'}),
  DirectiveSpec('on',
      category: DirectiveCategory.events,
      shape: DirectiveShape.structural,
      named: <String>{'once'}),
  DirectiveSpec('endon',
      category: DirectiveCategory.events, shape: DirectiveShape.terminator),
  DirectiveSpec('schedule',
      category: DirectiveCategory.events,
  ...
  DirectiveSpec('achievement_progress',
      category: DirectiveCategory.achievements,
      named: <String>{'value', 'goal'}),

  // ── UI ──────────────────────────────────────────────────────────────────
  DirectiveSpec('ui',
      category: DirectiveCategory.ui, named: <String>{'mode', 'value'}),
  DirectiveSpec('toast',
      category: DirectiveCategory.ui, named: <String>{'duration', 'icon'}),
  DirectiveSpec('banner',
      category: DirectiveCategory.ui, named: <String>{'duration', 'style'}),
  DirectiveSpec('overlay',
      category: DirectiveCategory.ui, named: <String>{'opacity', 'color'}),
  DirectiveSpec('screen',
      category: DirectiveCategory.ui, named: <String>{'args'}),
  DirectiveSpec('dialog',
      category: DirectiveCategory.ui,
      named: <String>{'title', 'body', 'confirm', 'cancel'}),
  DirectiveSpec('hud',
      category: DirectiveCategory.ui, named: <String>{'show', 'hide'}),
  DirectiveSpec('title_card',
      category: DirectiveCategory.ui,
      named: <String>{'subtitle', 'duration', 'style'}),
  DirectiveSpec('credits', category: DirectiveCategory.ui),

  // ── Premium (crystals) ──────────────────────────────────────────────────
  DirectiveSpec('crystals',
      category: DirectiveCategory.premium,
      named: <String>{'reason', 'silent'},
      summary: 'Grants or spends crystals.'),
  DirectiveSpec('require_crystals',
      category: DirectiveCategory.premium, named: <String>{'else'}),
  DirectiveSpec('open_store',
      category: DirectiveCategory.premium, named: <String>{'sku', 'reason'}),
  DirectiveSpec('premium_unlock',
      category: DirectiveCategory.premium,
      named: <String>{'cost', 'title', 'else'}),

  // ── Network (simulated, offline) ────────────────────────────────────────
  DirectiveSpec('network',
