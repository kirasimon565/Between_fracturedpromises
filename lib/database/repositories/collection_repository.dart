...
class CollectionRepository {
  ...
  Future<Map<String, bool>> completedEpisodes() async {
    final List<QueryRow> rows =
        await _db.rows('SELECT episode_id, completed_at FROM episode_progress');
    return <String, bool>{
      for (final QueryRow r in rows)
        r.read<String>('episode_id'): r.readNullable<int>('completed_at') != null,
    };
  }
}
